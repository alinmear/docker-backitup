...
_provided_conf="/tmp/docker-backup/duplicity-backup.conf"
[ -f "${_provided_conf}" ] && cp "${_provided_conf}" /etc/duplicity-backup.conf 

override_config "DUPLICITY_" "/etc/duplicity-backup.conf"
